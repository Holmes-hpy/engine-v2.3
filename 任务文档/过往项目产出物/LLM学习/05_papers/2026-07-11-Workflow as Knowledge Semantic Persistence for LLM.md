...
## 论文基本信息
- **标题**：Workflow as Knowledge: Semantic Persistence for LLM-Mediated Workflows
- **作者**：Emanuele Quinto, Carlo Andrea Rozzi, Francesco Zanitti
- **机构**：Emanuele Quinto、Carlo Andrea Rozzi、Francesco Zanitti
- **会议/期刊**：arXiv
- **发表时间**：2026-07-09
...
**论文标题**：Workflow as Knowledge: Semantic Persistence for LLM-Mediated Workflows
